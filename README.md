...
* [Scientific Modeling Cheatsheet (MATLAB – Python – Julia Quick Reference))](https://sciml.github.io/Julia_Modeling_Workshop/scientific_modeling_cheatshet) - A cheatsheet for converting between MATLAB, Python, and Julia
