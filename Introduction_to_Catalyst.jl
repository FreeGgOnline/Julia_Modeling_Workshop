...
Let's now use our `ReactionSystem` to generate and solve a corresponding mass action ODE model. We first convert the system to a `ModelingToolkit.ODESystem`:
"""
...
# ╔═╡ 885f5685-5239-42aa-942c-2b9bdf7df226
# Process the inputs for the jump problem
jinputs = JumpInputs(rn, u₀map_int, tspan, pmap)
...
jprob_sorting = JumpProblem(jinputs, SortingDirect())
...
manifest_format = "2.0"
project_hash = "7c998f4bd7923bb3bf737e75b6c00efd3ca98dc5"
